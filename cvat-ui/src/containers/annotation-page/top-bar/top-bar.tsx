...
class AnnotationTopBarContainer extends React.PureComponent<Props, State> {
    ...
    public componentDidMount(): void {
        const { autoSaveInterval, history, jobInstance, t, } = this.props;
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslation()(AnnotationTopBarContainer)));
